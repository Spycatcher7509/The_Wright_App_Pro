    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          ...
          >
            {verifyResult === 'VALID' ? 'Verified ✓' : verifyResult === 'INVALID' ? 'Checksum Mismatch ✗' : 'Verify'}
          </button>
        </div>
      </div>
                      ...
                      <td colSpan={4} className="px-8 py-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs">
                          <div className="space-y-4">
                            <div>
                              <p className="font-bold text-slate-500 uppercase mb-1">File Checksum (SHA-256)</p>
                              <p className="mono p-3 bg-white rounded-xl border border-slate-200 text-indigo-700 break-all shadow-inner">{log.checksum}</p>
                            </div>
                            <div>
